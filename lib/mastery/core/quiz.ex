defmodule Mastery.Core.Quiz do
  alias ElixirLS.LanguageServer.Experimental.Protocol.Proto.Response
  ...
  when map_size(templates) == 0 do
    %__MODULE__{
      quiz |
      templates: Enum.group_by(used, fn t -> t.category end),
      used: []
    }
  end
  ...
  defp pick_current_question(quiz), do: Map.put(quiz, :current_question, select_a_random_question(quiz))
